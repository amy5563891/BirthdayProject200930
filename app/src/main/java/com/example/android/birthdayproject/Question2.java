...
public class Question2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(MainActivity.answers[1]!=0){
            switch(MainActivity.answers[1]){
                case 1:
                    B1click(button1);
                    break;
                case 2:
