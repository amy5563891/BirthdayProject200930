...
public class Question1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(MainActivity.answers[0]!=0){
            switch(MainActivity.answers[0]){
                case 1:
                    B1click(button1);
                    break;
                case 2:
